...
st.write("Le fichier release disponible via GitHub a été au maximum anonymisé pour respecter la RGPD.")
...
st.write(
    "Cette analyse a but uniquement éducatif est réalisé sur l'ensemble "
    "des 5 derniers fichiers DVF disponible sur data.gouv.fr en date du 26/07/2026. "
    "La construction de cette application est double : répondre à des "
    "interrogations personnels sur le marché de l'immobilier en France et "
    ...
    "- Une page d'analyse global qui met en avant des métriques sur le marché "
    "de l'immobilier ainsi que des graphiques intéractifs pour visualiser ces derniers.\n"
    ...
    "un apprentissage continue en mathématique et en développement.\n\n"
    "En fond, les statistiques sont calculés de deux manières différentes : une via la méthode manuel afin d'appliquer les modèle mathématique au plus proche et une en utilisant la bibliothèque *scipy* afin de vérifier et de valider mes résultats *fait main*"
