...
def afficher_section_carte(df_map, geojson_france):
    ...
    types_selectionne = st.pills(
        "Type de bien :", 
        options=types_disponible, 
        default=types_disponible,
...
index_defaut = commune.index('COMPIEGNE')
...
st.header('Analyse globale du marché entre 2021 et 2025')
